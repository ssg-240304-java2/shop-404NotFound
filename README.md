...
- 👨‍💻 안준렬: 웹페이지를 직접 구현해보니 신경써야할게 되게 많았다. 처음이다보니 미숙했는데 이번경험으로 웹페이지구현 흐름에대해<br>
알게 되었고, Git Flow 형상관리에 대해서 직접 실천해보고 경험할 수 있어서 조금은 익숙해진것 같다.<br>
프로젝트기간이 짧다보니 구현하고 싶은 기능들을 전부다 구현하지 못해서 아쉬웠다.<br>
개발을 해보면서 발견했던 단점들을 줄여나가서 다음프로젝트떄는 목표한 기능들을 구현해내고싶다.<br>
